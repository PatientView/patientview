<%@ page import="org.patientview.patientview.unit.UnitUtils" %>
...
<logic:iterate id="contact" name="contacts">
    <%-- Do not show ECS unit in contact list --%>
    <logic:notEqual value="<%=UnitUtils.ECS_UNITCODE%>" name="contact" property="unit.unitcode">
