...
<p align="center">
    <html:link action="/patient/sharingThoughtsUserList"><html:submit value="Your Thoughts" styleClass="btn formbutton btn-sharingthoughts " /></html:link>
    &nbsp;&nbsp;&nbsp;
    <html:link action="/patient/sharingThoughtsSummary"><html:submit value="Monthly Feedback Summary" styleClass="btn formbutton btn-sharingthoughts " /></html:link>
</p>
</div>