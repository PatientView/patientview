...
<p>
    PatientView is an interactive website to help support patients.
</p>

<p>
    The website provides secure access to your blood tests, clinic letters and your medicines. You'll find tailored information links, from accurate and reliable sources. We hope it will help you manage your condition more effectively.
</p>
...
<dl class="flush-dl">
    ...
    <dd>
        <p>
            ...
            from your local hospital's computer system, you should contact your clinic or GP if you see (or suspect) errors.
        </p>
        <p>
    ...
    <dd>
        Patients can, a patient's GP can, and a limited number of staff from the team can. Also, patients may share their
    ...
    <dd>
        ...
        <ul>
            ...
            <li>
                Unit staff who have logins may see the records of any PatientView patient from their unit.
            </li>
        </ul>
        <p>
    ...
    <dd>
        <p>
            ...
            made in the local records. When a change is made, it may not be updated on the PatientView for up to 48h.
        </p>
        <p>
