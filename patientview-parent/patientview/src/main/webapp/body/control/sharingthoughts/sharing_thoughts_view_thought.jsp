...
<div class="span9">
    ...
    <h2>Responders</h2>
    <p>Must be members of the unit referred to in the Shared Thought. Staff members who are Shared Thought Administrators can see all Shared Thoughts in their units.</p>
    <br/>
